...
ALTER TABLE FACULTY
Add EmploymentStatus varchar(1) check (EmploymentStatus in ('R', 'P'))
...
INSERT INTO FACULTY (EmpID, Fname, MName, LName, BDate, EmpRank, Position, EmployeeStatus, Hiredate, Salary, RATA, SupervisorID, ColCode)
...
'Instructor II', 'Faculty', 'C', '2015-06-10',
